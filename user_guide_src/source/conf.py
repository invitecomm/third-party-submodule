...
latex_documents = [
  ('index', 'CodeIgniter.tex', u'CodeIgniter Documentation',
   u'INVITE Communications Co., Ltd.', 'manual'),
]
...
man_pages = [
    ('index', 'codeigniter', u'CodeIgniter Documentation',
     [u'INVITE Communications Co., Ltd.'], 1)
]
...
epub_title = u'HMVC-RV'
epub_author = u'INVITE Communications Co., Ltd.'
epub_publisher = u'INVITE Communications Co., Ltd.'
epub_copyright = u'2017 INVITE Communications Co., Ltd.'
